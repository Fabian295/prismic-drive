    ...
    >
        ...
        <div className="es-alternate-grid__primary-content">
          ...
          {slice.primary.items.length > 0 && (
            <div className="es-alternate-grid__primary-content__items">
              {slice.primary.items.map((item, i) => <div key={`item-${i + 1}`} className="es-alternate-grid__item">
      ...
      <div className="es-alternate-grid__item__heading">
        <PrismicRichText field={item.title} />
				  ...
				  <PrismicNextLink field={item.landing_button}>
				  </PrismicNextLink>
				  {/* <PrismicNextImage field={item.landing_thumbnail}> </PrismicNextImage> */}


				  {/* {isFilled.richText(item.) && (
